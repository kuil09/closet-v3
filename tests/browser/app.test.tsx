...
describe("app flows", () => {
  ...
  test("keeps mobile wardrobe controls minimal until advanced filters are opened", async () => {
    const user = userEvent.setup();
    const view = renderAt("/wardrobe", 768);
    ...
    expect(view.queryByRole("button", { name: /^Favorites$/ })).toBeNull();
